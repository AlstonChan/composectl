...
var serviceCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		includeAllFiles, _ := cmd.Flags().GetString("all")

		fmt.Printf("service: name - %s, sequence - %d, includeAllFiles - %t", name, sequence, includeAllFiles)
	},
}
...
func init() {
	...
	serviceCmd.Flags().IntP("sequence", "s", 0, "The sequence of the service")
